...
int main() {
    ...
    struct T_Value res1 = T_Array_find(arr, T_Value_from_string(a));
    struct T_Value res2 = T_Array_find(arr, T_Value_from_string(b));
    struct T_Value res3 = T_Array_find(arr, T_Value_from_int(1337));
    struct T_Value res4 = T_Array_find(arr, T_Value_from_int(1234));
